...
cargo bench --bench query_baseline -- --save-baseline before_all_perf mixed_scope

DATASTORE_QUERY_BENCH_SAMPLES=20 \
DATASTORE_QUERY_BENCH_MEASUREMENT_SECONDS=3 \
cargo bench --bench query_baseline -- --save-baseline before_all_perf update_one_field_many_indexes
```
